...
3. 修复带缩进的纯文本行不渲染为思维导图子节点的问题
4. 修复 AI 生成的列表节点被错误转换为标题节点的问题
5. 修复 如果人为填入Markdown 粗体格式（`**文本**`）在思维导图中不显示加粗效果的问题
6. 修复截图下载时粗体文字显示 `</strong>` 标签而不是加粗效果的问题，现在截图中的粗体文字会正确显示为加粗
7. 美化滚动条样式
