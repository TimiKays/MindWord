## 0.57 (2025/12/7)
### 功能
1. 全面优化PWA离线访问功能，解决iframe和思维导图图标离线显示问题；
2. 增强Service Worker缓存策略，支持动态资源预缓存；
3. 增加快速生成子目录菜单以及移动端交互（不完全适配）

### BUG
1. 修复PWA应用离线模式下iframe显示"内容不可用"的问题；
2. 修复思维导图页面图标在离线模式下不显示的问题；
3. 清理项目中的测试文件和调试文件；
4. 修复配置AI之后报不支持此平台
---
