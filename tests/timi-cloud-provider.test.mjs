...
test('默认模式加载统一账户 SDK，legacy 参数才回退旧链路', async () => {
  ...
  assert.ok(unified.loaded.some(src => src.endsWith('/sdk/topbar.js?v=2.0.3')));
  assert.ok(unified.styles.some(href => href.endsWith('/sdk/topbar.css?v=2.0.3')));
  ...
  assert.deepEqual(plain(unified.topbarInitConfig.menu), {
    showAccount: true,
    showMembership: true,
    showInvite: false,
    showLogout: true,
