...
function showLocalNotification(message, type = 'info', duration = 1500) {
    ...
    const notificationHtml = `
        <div id="${notificationId}" class="alert alert-dismissible fade show position-fixed" 
             style="top: 20px; right: 20px; z-index: 9999; min-width: 300px; box-shadow: 0 4px 6px rgba(0,0,0,0.1); ${typeStyles[type] || typeStyles.info}">
            ${message}
