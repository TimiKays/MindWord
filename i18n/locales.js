  ...
  zh: {
    ...
    app: {
      ...
      toolbar: {
        ...
        outlineView: '大纲视图',
        mindmapView: '导图视图',
        outlineAddSibling: '添加同级',
        outlineIndent: '缩进',
        outlineOutdent: '提升',
        outlineNavigate: '导航',
        outlineDeleteEmpty: '删除空节点',
        outlineNotesHint: '备注',
        outlinePlaceholder: '输入内容...',
        outlineRootPlaceholder: '输入主题...',
        outlineNoContent: '暂无内容',
  ...
  en: {
    ...
    app: {
      ...
      toolbar: {
        ...
        outlineAddSibling: 'Add Sibling',
        outlineIndent: 'Indent',
        outlineOutdent: 'Outdent',
        outlineNavigate: 'Navigate',
        outlineDeleteEmpty: 'Delete Empty Node',
        outlineNotesHint: 'Notes',
        outlinePlaceholder: 'Type here...',
        outlineRootPlaceholder: 'Enter topic...',
        outlineNoContent: 'No Content',
  ...
  es: {
    ...
    app: {
      ...
      toolbar: {
        ...
        outlineView: 'Vista de Esquema',
        mindmapView: 'Vista de Mapa Mental',
        outlineAddSibling: 'Agregar Hermano',
        outlineIndent: 'Sangría',
        outlineOutdent: 'Reducir Sangría',
        outlineNavigate: 'Navegar',
        outlineDeleteEmpty: 'Eliminar Nodo Vacío',
        outlineNotesHint: 'Notas',
        outlinePlaceholder: 'Escribir aquí...',
        outlineRootPlaceholder: 'Ingresar tema...',
        outlineNoContent: 'Sin Contenido',
